...
# ### DOWNLOAD DATASETS FROM GOOGLEAPIS
import pathlib
...
# print(len(roses))
# rose1 = PIL.Image.open(str(roses[0]))
# rose1.show()
# rose2 = PIL.Image.open(str(roses[1]))
# rose2.show()

# """And some tulips:"""
# tulips = list(data_dir.glob('tulips/*'))
# print(len(tulips))
# tulip1 = PIL.Image.open(str(tulips[0]))
# tulip1.show()
# # tulip2 = PIL.Image.open(str(tulips[1]))
# # tulip2.show()
...
val_ds   = tf.keras.preprocessing.image_dataset_from_directory(data_dir,
                                                               ...
                                                               image_size=(img_height, img_width),
                                                               batch_size=batch_size)
# test_ds   = tf.keras.preprocessing.image_dataset_from_directory('flower_test',
#                                                                image_size=(img_height, img_width),
#                                                                batch_size=batch_size)
# print(test_ds)
# sys.exit(0)
...
for image_batch, labels_batch in train_ds:
  ...
  print('Labels size: ', labels_batch.shape)
  break
...
# There's a fully connected layer with 128 units on top of it that is activated by a `relu` activation function. This model has not been tuned for high accuracy, the goal of this tutorial is to show a standard approach.
# """
# num_classes = 5
# model = Sequential([
...
# """## Compile the model
# For this tutorial, choose the `optimizers.Adam` optimizer and `losses.SparseCategoricalCrossentropy` 
# loss function. To view training and validation accuracy for each training epoch, pass the `metrics` argument.
# """
...
"""As you can see from the plots, training accuracy and validation accuracy are off by large margin and 
...
Also, the difference in accuracy between training and validation accuracy is noticeable—a sign of 
[overfitting](https://www.tensorflow.org/tutorials/keras/overfit_and_underfit).

When there are a small number of training examples, the model sometimes learns from noises or unwanted details from training examples—to an extent 
that it negatively impacts the performance of the model on new examples. This phenomenon is known as overfitting. 
...
[Data augmentation](https://www.tensorflow.org/tutorials/images/data_augmentation) takes the approach of generating additional training data 
...
[Dropout](https://developers.google.com/machine-learning/glossary#dropout_regularization) to the network, a form of *regularization*.
